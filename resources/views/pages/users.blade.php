            ...
            <table class="table table-bordered table-striped dt-responsive tables" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>admin</td>
                  <td><img src="{{asset('img/users/default/anonymous.png')}}" class="img-thumbnail" width="40px"></td>
                  <td>Administrator</td>
              ...
              <div class="modal-body">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{asset('img/users/default/anonymous.png')}}" class="img-thumbnail" width="100px">
